...
void Print1(char *name,int arg1);
void Print2(char *name,int arg1, int arg2);
void Print3(char *name,int arg1, int arg2, int arg3);
void PrintTest(char *name);

int CreateLock(char *name,int len,int num);
void AcquireLock(int lockID);
void ReleaseLock(int lockID);
void DestroyLock(int lockID);

int CreateCV(char *name,int len,int num);
void SignalCV(int lockID,int cvID);
void WaitCV(int lockID,int cvID);
void BroadcastCV(int lockID,int cvID);
void DestroyCV(int cvID);

int CreateMV(char *name,int len,int initialValue,int num);
void SetMV(int mvID,int value);
int GetMV(int mvID);
void DestroyMV(int mvID);
void EndSimulation(int ID);
